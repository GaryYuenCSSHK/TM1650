 ...
 */
//% weight=100 color=#64C800 icon="\uf1d5" block="LoboRobot 4-Digit Display"
namespace TM1650 {
     ...
     */
    //% blockId="TM650_SHOW_DP" block="show decimal point at %bit|show %show"
    //% weight=80 blockGap=8
     ...
     */
    //% blockId="TM650_INTENSITY" block="set display intensity to %dat"
